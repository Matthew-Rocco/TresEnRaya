...
public class HiloServidor implements Runnable{
    ...
    public void run() {
        try {
            ...
            //Si ocurre una excepcion lo mas seguro es que sea por que algun jugador se desconecto asi que se quita de la lista de conectados
    ...
    public boolean gano(int n){
        ...
        if(G[0][2] == n && G[1][1] == n && G[2][0] == n)return true;
